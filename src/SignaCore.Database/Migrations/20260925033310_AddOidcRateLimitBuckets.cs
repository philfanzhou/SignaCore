        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    partition_digest = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    window_expires_at = table.Column<DateTimeOffset>(type: "timestamptz", nullable: false),
