        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    code_digest = table.Column<string>(type: "character varying(71)", maxLength: 71, nullable: false),
                    app_registration_id = table.Column<Guid>(type: "uuid", nullable: false),
                    account_id = table.Column<Guid>(type: "uuid", nullable: false),
                    identity_session_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    refresh_family_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
