        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    directory_key = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    directory_key_normalized = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    object_guid = table.Column<Guid>(type: "uuid", nullable: false),
                    user_principal_name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    user_principal_name_normalized = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    sam_account_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    sam_account_name_normalized = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ldap_credential_id = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ldap_credentials_directory_key_normalized_sam_account_name_~",
                table: "ldap_credentials",
                columns: new[] { "directory_key_normalized", "sam_account_name_normalized" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ldap_credentials_directory_key_normalized_user_principal_na~",
                table: "ldap_credentials",
