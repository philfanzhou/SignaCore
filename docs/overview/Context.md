...
Primary implementation: .NET 10, ASP.NET Core, EF Core, PostgreSQL/SQLite, Vue 3, Consul, ServiceMantle (including its Serilog logging pipeline), OpenTelemetry, and Prometheus.
