...
| Loki / OTLP / Prometheus | Logs, traces, and metrics; `/metrics` requires registered application credentials and OTLP requires HTTPS (see [Configuration](../development/Configuration.md#metrics-and-traces)) |
