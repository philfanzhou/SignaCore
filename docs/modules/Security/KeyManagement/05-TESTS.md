# Signing Key Management: Test Plan

## Required coverage

Tests should cover initial key creation, encryption round trips, rotation timing, active-key selection, malformed master keys, concurrent initialization, and JWKS output.
