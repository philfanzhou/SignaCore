...
Relevant tables: accounts, app_registrations, app_exchange_trusts, password_credentials, otps, user_logins, login_attempts, and refresh_tokens. PostgreSQL migrations live in Database, while SQLite uses its provider-specific migration assembly.
