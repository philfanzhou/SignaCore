...
| [0005](./0005-interactive-oidc-authorization-code.md) | Accepted | Deliver OIDC Authorization Code with mandatory S256 PKCE for pre-registered first-party confidential BFFs, with an identity session isolated from the admin cookie |
